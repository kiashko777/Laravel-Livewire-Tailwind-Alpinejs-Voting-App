...
<header class="flex items-center justify-between px-8 py-4">
  ...
  <div class="flex items-center">
    ...
    <a href="#"><img
        ...
        alt="avatar" class="w-10 h-10 rounded-full"/></a>
  </div>
</header>

<main class="container mx-auto flex max-w-custom">
  <div class="w-70 mr-20">
    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid cum cupiditate dicta dolor dolorum eos error
    exercitationem expedita fugiat impedit modi nam qui, repellat sequi voluptatum? Aut commodi consectetur error
    excepturi nobis placeat praesentium quasi similique tempore. Aut, sunt, veniam.
  </div>
  <div class="w-175">
    <nav class="flex items-center justify-between text-xs">
      ...
      <ul class="flex uppercase font-semibold space-x-10 border-b-4 pb-3">
        <li><a href="#" class="border-b-4 pb-3 border-blue">Implemented (21)</a></li>

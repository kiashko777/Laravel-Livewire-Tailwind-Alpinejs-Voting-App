          ...
          <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
            ...
            >
              ...
              >
                ...
                >
                  <li><a href="#" class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3">Mark as
                      Spam</a></li>
                  <li><a href="#" class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3">Delete
                      Post</a></li>
                </ul>
              </button>
            </div>
    ...
    <div
      ...
      <div class="flex flex-col md:flex-row flex-1 px-2 py-6">
        ...
        <div class="w-full flex flex-col justify-between mx-2">
          ...
          <div class="text-gray-600 mt-3 line-clamp-3">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Et dignissimos odit possimus culpa assumenda
            repellendus ipsam. Placeat, fuga reprehenderit, eius minus nam aliquid vel beatae, consequatur deserunt
            necessitatibus corporis sequi.
          </div>
...
{{--OTHER TYPES OF CARDS WITH STYLES--}}
...
{{--      </h4>--}}
{{--      <div class="text-gray-600 mt-3 line-clamp-3">--}}
{{--        Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum possimus quasi reprehenderit earum incidunt. Ad--}}
{{--        reprehenderit repudiandae dolorem ducimus modi accusamus beatae perferendis? Eum eligendi nulla aliquam numquam!--}}
{{--        Nobis, tempore rerum autem accusamus perspiciatis laudantium at excepturi sint placeat nulla beatae qui aliquam--}}
{{--        quibusdam corrupti vel dolor praesentium quam dolore itaque deleniti quod in ut earum. Cum fuga ea molestias--}}
{{--        nesciunt soluta sint maxime, magnam dolorum reprehenderit autem, vel ipsa? Vitae vel quos quaerat, fugit in--}}
{{--        reiciendis alias perspiciatis esse numquam facere cum veniam beatae voluptatem eos amet vero laborum error.--}}
...
{{--              <li><a href="#" class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3">Mark as Spam</a>--}}
{{--              </li>--}}
{{--              <li><a href="#" class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3">Delete Post</a>--}}
{{--              </li>--}}
{{--            </ul>--}}
{{--          </button>--}}
{{--        </div>--}}

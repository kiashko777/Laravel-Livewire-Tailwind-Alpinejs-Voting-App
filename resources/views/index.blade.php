<x-app-layout>
  <div class="filters flex space-x-6">
    ...
    <div class="w-1/3">
      <label for="other_filters"></label><select name="other_filters" id="other_filters"
                                                 class="w-full rounded-xl px-4 py-2 border-none">
      ...
      <div class="flex flex-1 px-2 py-6">
        ...
        <div class="w-full mx-4">
          ...
          <div class="text-gray-600 mt-3 line-clamp-3">
            ...
            reprehenderit repudiandae dolorem ducimus modi accusamus beatae perferendis? Eum eligendi nulla aliquam
            numquam! Nobis, tempore rerum autem accusamus perspiciatis laudantium at excepturi sint placeat nulla beatae
            qui aliquam quibusdam corrupti vel dolor praesentium quam dolore itaque deleniti quod in ut earum. Cum fuga
            ea molestias nesciunt soluta sint maxime, magnam dolorum reprehenderit autem, vel ipsa? Vitae vel quos
            quaerat, fugit in reiciendis alias perspiciatis esse numquam facere cum veniam beatae voluptatem eos amet
            vero laborum error. Dolor distinctio temporibus iure, repellendus porro molestiae deleniti quibusdam?
          </div>

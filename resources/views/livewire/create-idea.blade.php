<form wire:submit.prevent="createIdea" action="#" method="POST" class="space-y-4 px-4 py-6">
  ...
  <div>
    <label for="category_add"></label><select wire:model.defer="category" name="category_add" id="category_add"
  ...
  <div>
    <label for="idea"></label><textarea wire:model.defer="description" name="idea" id="idea" cols="30" rows="4"
...
{{--  BLOCK TO CREATE FLASH MESSAGES--}}
